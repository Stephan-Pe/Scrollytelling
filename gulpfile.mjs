...
task("build", series(runClean, parallel(processHTML, processCSS, copyFonts, processJS, processJson, imageMin)));


task("default", series(runClean, parallel(processHTML, processCSS, copyFonts, processJS, processJson, imageMin)));
